...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
    ...
    private Button mTakeBT, mThreeFourBT, mFourThreeBT, mNineSixteenBT, mSixteenNineBT, mFitImgBT, mCircleBT, mFreeBT, mSquareBT,
            mCircleSquareBT, mCustomBT,take_Scan;
    ...
    private void initView() {
        ...
        take_Scan =  findViewById(R.id.take_Scan);
    ...
    private void setListener() {
        ...
        take_Scan.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.take_bt:
                if (!focus) {
                    Log.e(TAG, "onClick1: "+focus);
                    takePicture();
                }else {
                    Log.e(TAG, "onClick2: "+focus);
                }
                break;
    ...
    private void takePicture() {
        Log.e(TAG, "onClick3: takePicture--------");
                ...
                if (success) {
                    ...
                    mCamera.takePicture(new Camera.ShutterCallback() {
                        ...
                        public void onPictureTaken(byte[] data, Camera camera) {
                            ...
                            try {
                                saveBitmap(originBitmap,"focusOriginBitmap");
                                saveBitmap(cropBitmap,"focusCropBitmap");
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                            pictureFragment.setArguments(bundle);
                            pictureFragment.show(getFragmentManager(), null);
                            Log.e(TAG, "onClick: onPictureTaken--------");
                            focus = false;
                            mCamera.startPreview();
                        }
                    });
    ...
    private void saveBitmap(Bitmap bitmap,String picName) throws IOException {
//        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + picName+".PNG");
//        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/focussv" + picName+".PNG");
        File file = new File(getAlbumStorageDir("Focussurfaceview"), String.format(picName+"_%d.PNG", System.currentTimeMillis()));
        if (file.exists()) {
//            file.delete();
        }
